  ...
  <div
    ...
    class="multiselect">
      <slot name="caret" :toggle="toggle">
        <div @mousedown.prevent.stop="toggle()" class="multiselect__select-wrap">
      ...
      <transition name="multiselect">
        ...
        >
          <ul class="multiselect__content" :style="contentStyle">
            ...
            <li v-show="showNoResults && (filteredOptions.length === 0 && search && !loading) && internalValue.length < max">
              <span class="multiselect__option">
...
export default {
  ...
  updated() {
      ...
      $('.multiselect__select-wrap').height($('.multiselect__tags-wrap').height() - 8);
  },
  computed: {
